<template>
  <div ref="divRef" style="width: 100%; height: 100vh; overflow-y: auto">
    <comparsion-dialog
    ...
    <div :class="`flex p-4 w-full sticky ${scrollTop > 50 ? 'box-shadow' : ''}`" style="max-height: 26%">
      <div class="grid inputContent" style="width: 86%; overflow: hidden">
      ...
      <div class="grid" style="min-width: 14%">
        ...
        <div v-if="filterList.length" class="col-12 flex align-items-center justify-content-center">
          <Button label="重置过滤条件" class="rest" @click="resetFilter" />
        </div>
      </div>
    </div>
    <div class="px-4">
