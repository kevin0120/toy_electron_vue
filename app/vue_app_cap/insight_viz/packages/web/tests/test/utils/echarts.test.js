...
import { tooltipFormatter, seriesLineFormatter, isShowTorqueAngle, isShowAngle, isShowTorque, getMarkLine, convertTo2DArray, getMarkPointData } from '../../../src/utils/echarts';
...
describe('Test seriesLineFormatter function', () => {
    const index = 1;
    const data = [{ value: [0, 1] }, { value: [1, 1] }, { value: [2, 3] }];
    const name = '测试数据';
    const showArea = true;
    const markLine = {
        x: {
